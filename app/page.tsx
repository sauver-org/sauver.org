...
const TERMINAL_SEQUENCE = [
  ...
  { delay: 300, type: 'info', text: '⏺ sauver - search_messages (MCP)' },
  {
    delay: 500,
    type: 'success',
    text: '⏺ Sauver v1.8.20 (up to date). Processing 20 inbox emails.',
  },
...
const EXAMPLE_SEQUENCE = [
  ...
  { delay: 300, type: 'info', text: '⏺ sauver - search_messages (MCP)' },
  {
    delay: 500,
    type: 'success',
    text: '⏺ Sauver v1.8.20 (up to date). Processing 40 inbox emails, newest first.',
  },
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 1: "Re: Partnership Opportunity" from Allison Yoder (adlinkcentral.com)',
  },
  { delay: 100, type: 'blocked', text: '  \u2298 Tracker: Salesforce beacon \u2014 stripped' },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 continuing credit line pitch, dodging specifics, pushing for a call',
  },
  { delay: 300, type: 'trap', text: '  \u27f9 Expert-Domain Trap \u2014 Drafted' },
  {
    delay: 100,
    type: 'detail',
    text: '  \u21b3 Asked about security interest structure, covenant terms, and default triggers',
  },
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 2: "Re: Instantly.ai" from Henrietta Foxwell (commsment.com)',
  },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 NDA Trap is the terminal move. Bot agreed to sign without pushback',
  },
  ...
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 3: "Re: FWD: Your Company" from Ryan Blevins (drivefinovausa.co)',
  },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 3+ messages, still deflecting document requests, offering to "loop in advisor"',
  },
  ...
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 4: "Re: Investment Opportunity" from Emily Hunter (selleradvisoryalliance.help)',
  },
  { delay: 100, type: 'blocked', text: '  \u2298 Tracker: UTM tracking in Calendly link' },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 investor bot sending identical Calendly links across multiple threads',
  },
  { delay: 300, type: 'trap', text: '  \u27f9 Investor Due Diligence Loop \u2014 Drafted' },
  {
    delay: 100,
    type: 'detail',
    text: '  \u21b3 Requested Track Record Disclosure, LP Transparency Report, KYC/AML certificate',
  },
  { delay: 600, type: 'sep', text: ' ' },
  ...
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 13: "Re: Podcast Invitation" from Tina Singh (thegrowthstacklimited.com)',
  },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 fake podcast invitation (no RSS feed for a supposed podcast)',
  },
  { delay: 300, type: 'trap', text: '  \u27f9 Expert-Domain Trap \u2014 Drafted' },
  {
    delay: 100,
    type: 'detail',
    text: '  \u21b3 Asked for distribution channel, Apple Podcasts link, and recent guest names',
  },
  { delay: 600, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'info',
    text: '⏺ Message 14: "Clearing Your Backlog" from Casey/Colton (themindrinds.org)',
  },
  {
    delay: 100,
    type: 'blocked',
    text: '  \u2298 Tracker: Salesforce ImageServer beacon \u2014 stripped',
  },
  {
    delay: 100,
    type: 'slop',
    text: '  \ud83d\udea8 Slop \u2014 unfilled [Name] placeholder, mismatched sender/signer',
  },
  { delay: 300, type: 'trap', text: '  \u27f9 Bouncer Reply \u2014 Drafted' },
  {
    delay: 100,
    type: 'detail',
    text: '  \u21b3 Requested quote for porting COBOL telemetry to a Commodore 64 cluster',
  },
  { delay: 800, type: 'sep', text: ' ' },
  {
    delay: 200,
    type: 'success',
    text: '\u2713 Done. 20 slop threads processed. 14 drafts created. 20 legitimate.',
  },
...
const steps = [
  {
    num: '01',
    title: 'Tracker Shielding',
    desc: 'Identifies and neutralizes 1×1 tracking pixels and surveillance beacons before they phone home.',
  },
  {
    num: '02',
    title: 'Slop Detection',
    desc: 'AI classification distinguishes genuine human outreach from machine-generated "job slop" and sales templates.',
  },
  {
    num: '03',
    title: 'Expert-Domain Traps',
    desc: 'Fires hyper-specific, technically demanding questions at recruiters to shift the cognitive load back to the sender.',
  },
  {
    num: '04',
    title: 'Bouncer Replies',
    desc: 'Engages generic spammers with absurd, bureaucratic, or confusing automated replies to waste their resources.',
  },
  {
    num: '05',
    title: 'Inbox Triage',
    desc: 'Categorizes, labels, and archives emails by content and risk level, keeping your focus on what matters.',
  },
  {
    num: '06',
    title: 'NDA Trap',
    desc: 'When a sender repeats the same pitch 3 or more times, Sauver sends them an NDA to sign before any further communication.',
  },
  {
    num: '07',
    title: 'Bot Detection',
    desc: 'Detects near-instant replies across consecutive exchanges, silently archiving bot-driven threads.',
  },
];
      ...
      <main>
        ...
        <section className="hero">
          <div className="hero-content">
            <div
              className="hero-eyebrow mono reveal"
              style={{ transitionDelay: '0.1s' }}
              ref={addToRefs}
            >
              <div className="dot-blink" />[ THE RESISTANCE IS ACTIVE ]
            </div>
            <h1 className="reveal" style={{ transitionDelay: '0.25s' }} ref={addToRefs}>
              KEEP AI SLOP OUT OF YOUR INBOX.
              <br />
            ...
            <div className="hero-btns reveal" style={{ transitionDelay: '0.55s' }} ref={addToRefs}>
              <Link href="#installation" className="btn btn-cta">
                Join The Resistance &rarr;
              </Link>
            ...
            <p
              className="hero-trust mono reveal"
        ...
        <section className="problem-strip">
          <div className="problem-content">
            <p className="section-label mono reveal" ref={addToRefs}>
              THE MANIFESTO
            </p>
            ...
            <p className="reveal" ref={addToRefs}>
              AI was supposed to make us 10x more productive. Instead, the attention merchants,
              including lead generators, growth hackers, and their armies of automated outreach
              tools, have weaponized it to build a slop-machine that bombards your inbox and taxes
              your sanity. They&apos;ve turned your most private tool, your email, into surveillance
              infrastructure for automated predators who see your time as raw material.
            </p>
            <p className="reveal problem-manifesto-close" ref={addToRefs}>
              It is not your fault.{' '}
              <strong>No human was ever meant to compete with a thousand bots.</strong>
            </p>
          </div>
        </section>
        ...
        <section className="section-container manifesto-section">
          ...
          <div className="manifesto-grid">
            {[
              {
                n: '01',
                text: 'The attention merchants, including lead generators, growth hackers, and their armies of automated tools, were handed AI and used it to build a slop-machine that bombards your inbox and taxes your sanity.',
              },
              {
                n: '02',
                text: "No human was ever meant to compete with a thousand bots firing at them simultaneously. The system isn't broken. It's working exactly as they intended.",
              },
              {
                n: '03',
                text: 'We confirm what you\'ve always suspected: that "personalized" pitch was written by a machine, and that hidden pixel is watching you. We make your defense active.',
              },
              {
                n: '04',
                text: 'None of us are fighting alone. Every trap deployed, every pixel stripped, and every bouncer reply sent by any of us drains their resources. Our collective resistance is a DDoS against the attention economy.',
              },
              {
                n: '05',
                text: "People like us don't accept the default. We fight back. Together we overwhelm them.",
              },
            ].map((item) => (
          ...
          <p className="manifesto-close reveal" ref={addToRefs}>
        ...
        <section id="who-it-is-for" className="section-container">
          <div className="section-header reveal" ref={addToRefs}>
            ...
            <h2>
              THE RESISTANCE IS <span>PEOPLE LIKE YOU</span>
            </h2>
          </div>
          <div className="grid-features">
            ...
            <div className="feature-card reveal" ref={addToRefs}>
              ...
              <h3>The Fighter</h3>
              <p>
                You don&apos;t just want slop filtered. You want the senders to feel it. You believe
                passive filtering is letting them win.
              </p>
            </div>
            <div className="feature-card reveal" ref={addToRefs}>
              <div className="feature-icon">
          ...
          <div className="how-it-works-inner">
            <div>
              <div className="section-header section-header-left reveal" ref={addToRefs}>
                ...
                <h2>
                  SEVEN LAYERS OF <span>DEFENSE</span>
                </h2>
              </div>
            ...
            <div
              className="how-it-works-image reveal"
        ...
        <section className="strike-back-section">
          <div className="strike-inner">
            <div className="section-label mono reveal" ref={addToRefs}>
              THE BOUNCER REPLY
            </div>
            ...
            <p className="strike-desc reveal" style={{ transitionDelay: '0.2s' }} ref={addToRefs}>
              When Sauver detects a recruiter mass-blast or sales template, it doesn&apos;t just
              archive it. It deploys an <strong>Expert Domain Trap</strong>, a hyper-specific
              technical challenge no automated system can answer. The cognitive load shifts
              permanently back to the sender.
            </p>
            <div
              className="strike-features reveal"
            ...
            >
              <div className="strike-feature">
                ...
                <p>
                  Hyper-specific questions only a real human can answer, customized to the
                  sender&apos;s claimed domain.
                </p>
              </div>
              <div className="strike-feature">
                <div className="strike-feature-icon">⊘</div>
                ...
                <p>
                  Engages generic spammers with absurd, bureaucratic, or confusing automated replies
        ...
        <section id="installation" className="section-container">
          <div className="section-header reveal" ref={addToRefs}>
            ...
            <h2>
              ONE COMMAND. <span>THAT&apos;S IT.</span>
            </h2>
          </div>
          ...
          <div className="installation-content">
            ...
            <div className="install-step reveal" ref={addToRefs}>
              ...
              <p className="install-detail-link">
                No OAuth setup, no API keys, no manual configuration.{' '}
                <Link href="/docs#installation">See the full setup guide &rarr;</Link>
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="stay-in-the-loop" className="section-container">
          <div className="newsletter-wrapper reveal" ref={addToRefs}>
            ...
            <h2>
              THE BOTS WILL ADAPT.
              <br />
              <span>SO WILL WE.</span>
            </h2>
            <p className="newsletter-desc">
              AI spammers are constantly changing their tactics. Drop your email below, and
              we&apos;ll ping you only when there are major core updates or new filters added to the
              repository.
            </p>
            ...
            <form className="slop-free-form" onSubmit={handleSubscribe}>
              ...
              <p className="micro-copy mono">
                We build tools to destroy spam. We aren&apos;t going to send you any. 100%
                slop-free.
                <br />
        ...
        <section className="section-container">
          <div className="section-header reveal" ref={addToRefs}>
            ...
            <h2>
              WHAT <span>/SAUVER</span> LOOKS LIKE
            </h2>
          </div>

          <div className="example-content reveal" ref={addToRefs}>
            <p className="example-intro">
              Type <code>/sauver</code> in Claude Code or Gemini CLI. Sauver scans your inbox,
              strips trackers, classifies each email, and drafts counter-measures — all in one shot.
            </p>

            <AnimatedTerminal
              sequence={EXAMPLE_SEQUENCE}
              title="claude — /sauver"
              className="example-terminal"
            />
          </div>
        </section>
      </main>
