...
const COMMANDS = [
  { cmd: '/sauver',         desc: 'Full triage — scans inbox, strips trackers, classifies intent, and drafts or sends counter-measures.' },
  { cmd: '/tracker-shield', desc: 'Strip tracking pixels and spy-links from a specific email.' },
  { cmd: '/slop-detector',  desc: 'Classify recruiter/sales slop and reply with the Expert-Domain Trap.' },
      ...
      <div className="docs-hero-bar">
        <div className="docs-hero-inner">
          ...
          <p className="docs-hero-sub">
            Everything you need to install, configure, and use Sauver — the cyber-defense layer for your Gmail inbox.
          </p>
        </div>
      </div>
      ...
      <div className="docs-layout">
        ...
        <aside className={`docs-sidebar ${mobileSidebarOpen ? 'open' : ''}`}>
          <div className="docs-sidebar-inner">
            ...
            <div className="docs-sidebar-cta">
              <Link href="https://github.com/mszczodrak/sauver" target="_blank" className="docs-github-link">
        ...
        <main className="docs-main">
          ...
          <section id="overview" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>OVERVIEW</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>What Sauver Does</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              Sauver is a cyber-defense layer for Gmail. It strips tracking pixels, identifies recruiter, sales, and investor &quot;slop,&quot; and wastes spammers&apos; time with automated traps. It runs inside <strong>Claude Code</strong> and <strong>Gemini CLI</strong> via a local MCP server — no background daemons, no cloud services of its own, no API keys.
            </p>

            <div className="doc-feature-grid reveal" ref={addToRefs}>
              {[
                { icon: '⊘', title: 'Tracker Shield', desc: 'Strips 1×1 tracking pixels and surveillance beacons from HTML emails before they phone home.' },
                { icon: '⚡', title: 'Slop Detection', desc: 'AI classification separates genuine human outreach from automated recruiter and sales templates.' },
          ...
          <section id="installation" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>INSTALLATION</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Three-Minute Setup</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              One command is all you need. The installer automates every step — no OAuth setup, no API keys, no gcloud.
              The only prerequisite is <strong>Node.js v18+</strong>.
            </p>
            ...
            <div className="doc-step reveal" ref={addToRefs}>
              ...
              <div className="doc-step-body">
                ...
                <CodeBlock copyText="curl -fsSL https://sauver.org/install.sh | bash">
                  <span className="tok-key">curl</span> -fsSL https://sauver.org/install.sh | <span className="tok-key">bash</span>
                </CodeBlock>
              </div>
            </div>
            ...
            <div className="doc-step reveal" ref={addToRefs}>
              ...
              <div className="doc-step-body">
                ...
                <div className="doc-info-box">
                  ...
                  <p>No third-party OAuth, no service accounts. The Apps Script runs <em>as you</em> inside your own Google account, using the same Gmail APIs Gmail itself uses.</p>
                </div>
              </div>
            </div>
            ...
            <div className="doc-step reveal" ref={addToRefs}>
              ...
              <div className="doc-step-body">
                ...
                <p className="doc-p" style={{ marginTop: 0 }}>
                  The installer uses <code>clasp</code> to create, configure, and deploy the Google Apps Script backend automatically. No manual steps in the Apps Script editor.
                </p>
              </div>
            </div>
                ...
                <div className="doc-client-row">
                  <div className="doc-client-card">
                    ...
                    <ul className="doc-client-list">
                      <li>MCP server → <code>~/.claude/settings.json</code></li>
                      <li>Slash commands → <code>~/.claude/commands/</code></li>
                    </ul>
                  </div>
                  <div className="doc-client-card">
                    <h4 className="doc-client-title">Gemini CLI</h4>
                    <ul className="doc-client-list">
                      <li>MCP server → <code>~/.gemini/settings.json</code></li>
                      <li>Slash commands → <code>~/.agent/workflows/</code></li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <section id="commands" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>COMMANDS</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Slash Commands</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              All six commands work identically in both Claude Code and Gemini CLI, from any working directory. You can also ask in plain English — e.g. <em>&quot;Sauver, triage my last 10 unread emails&quot;</em> or <em>&quot;Archive this thread under the Sauver label&quot;.</em>
            </p>
            ...
            <div className="doc-info-box reveal" ref={addToRefs} style={{ marginTop: '32px' }}>
              ...
              <p><strong>/sauver</strong> is the full orchestrator — it runs the complete pipeline. Use the individual commands when you want to target a specific email or action without running the full inbox scan.</p>
            </div>
          </section>
          ...
          <section id="configuration" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>CONFIGURATION</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Config Reference</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              Settings live in <code>~/.sauver/config.json</code> under the <code>preferences</code> key. You can edit the file directly, or simply ask your AI client — e.g. <em>&quot;turn on yolo mode&quot;</em> or <em>&quot;treat job offers as slop&quot;.</em>
            </p>
            ...
            <div className="doc-warn-box reveal" ref={addToRefs}>
              ...
              <p><strong>yolo_mode</strong> automatically sends counter-measure replies without draft review. Use only if you&apos;re confident in Sauver&apos;s classifications — misclassification of a legitimate email could send an unintended response.</p>
            </div>
          </section>
          ...
          <section id="architecture" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>ARCHITECTURE</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>How It Works</h2>
            <p className="doc-p reveal" ref={addToRefs}>
            ...
            <div className="doc-arch-diagram reveal" ref={addToRefs}>
              <div className="doc-arch-layer doc-arch-l1">
                ...
                <p className="doc-arch-layer-desc">Deployed to your Google account. Native Gmail access via <code>GmailApp</code> — no OAuth tokens, no service accounts. Exposes 9 Gmail actions over HTTPS.</p>
              </div>
              ...
              <div className="doc-arch-layer doc-arch-l2">
                ...
                <p className="doc-arch-layer-desc">A small Node.js process at <code>~/.sauver/mcp-server/</code>. Translates MCP tool calls → Apps Script HTTPS POSTs. Reads config from <code>~/.sauver/config.json</code>.</p>
              </div>
              ...
              <div className="doc-arch-clients">
                <div className="doc-arch-layer doc-arch-l3">
                  ...
                  <p className="doc-arch-layer-desc">Reads skill files from <code>~/.sauver/skills/</code>. Defense logic runs in the model.</p>
                </div>
                <div className="doc-arch-layer doc-arch-l3">
                  <div className="doc-arch-layer-label mono">LAYER 3</div>
            ...
            <h3 className="doc-h3 reveal" ref={addToRefs} style={{ marginTop: '48px' }}>Layer 1 — Google Apps Script</h3>
            <p className="doc-p reveal" ref={addToRefs}>
              <code>apps-script/Code.gs</code> is deployed as a Web App inside your own Google account. Because it runs as you, it has full native Gmail access — the same APIs Gmail itself uses. The Web App accepts HTTPS POST requests and routes them to one of nine actions:
            </p>
            ...
            <h3 className="doc-h3 reveal" ref={addToRefs} style={{ marginTop: '40px' }}>Layer 2 — Local MCP Server</h3>
            <p className="doc-p reveal" ref={addToRefs}>
              <code>mcp-server/index.js</code> is a small Node.js process that runs on your machine. It speaks the Model Context Protocol (MCP) over stdio, which is how Claude Code and Gemini CLI discover and call tools.
            </p>
            <p className="doc-p reveal" ref={addToRefs}>
              When Claude or Gemini calls a tool, the MCP server either handles it locally (for <code>get_preferences</code> and <code>set_preference</code>, which read/write <code>~/.sauver/config.json</code>) or forwards it as an HTTPS POST to the Apps Script Web App and returns the result.
            </p>

            <h3 className="doc-h3 reveal" ref={addToRefs} style={{ marginTop: '40px' }}>Layer 3 — AI Clients</h3>
            <p className="doc-p reveal" ref={addToRefs}>
              Both Claude Code and Gemini CLI connect to the same local MCP server and see the same 11 tools. The defense logic — tracker detection, slop classification, trap generation — runs entirely inside the AI model, guided by the skill files installed to <code>~/.sauver/skills/</code>. No defense logic lives in the MCP server or the Apps Script; they are pure data pipes.
            </p>
          </section>
          ...
          <section id="security" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>SECURITY</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Security Model</h2>
            ...
            <div className="doc-info-box reveal" ref={addToRefs} style={{ marginTop: '32px' }}>
              <span className="doc-info-icon">ℹ</span>
              <p>To revoke access at any time: In the Apps Script editor, click <strong>Deploy → Manage deployments</strong>, then delete the deployment. The Web App goes offline instantly. Or run the uninstaller.</p>
            </div>
          </section>
          ...
          <section id="updates" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>AUTO-UPDATES</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Skill Auto-Updates</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              The MCP server checks for updates automatically in the background on each startup, at most once per day. If a newer version is available, it silently downloads the updated skill files to <code>~/.sauver/skills/</code> and rewrites the command shims, then prints a one-line message to restart your AI client.
            </p>
            <p className="doc-p reveal" ref={addToRefs}>
            ...
            <div className="doc-info-box reveal" ref={addToRefs}>
              <span className="doc-info-icon">↻</span>
              <p>Skill auto-updates cover the skill files and command shims only. To update the <strong>MCP server itself</strong> or the <strong>Apps Script backend</strong>, re-run the installer:</p>
            </div>
            <CodeBlock copyText="curl -fsSL https://sauver.org/install.sh | bash">
              <span className="tok-key">curl</span> -fsSL https://sauver.org/install.sh | <span className="tok-key">bash</span>
            </CodeBlock>
          ...
          <section id="faq" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>FAQ</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Frequently Asked Questions</h2>
            ...
            <div className="doc-faq reveal" ref={addToRefs}>
              {FAQ_ITEMS.map((item, i) => (
                <div key={i} className={`doc-faq-item ${openFaq === i ? 'open' : ''}`}>
                  ...
                  >
                    <span>{item.q}</span>
                    <svg className="doc-faq-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <section id="uninstall" className="doc-section">
            <div className="doc-section-label mono reveal" ref={addToRefs}>UNINSTALLATION</div>
            <h2 className="doc-h2 reveal" ref={addToRefs}>Remove Sauver</h2>
            <p className="doc-p reveal" ref={addToRefs}>
              Run the uninstaller to cleanly remove everything Sauver added to your machine:
            </p>

            <CodeBlock copyText="curl -fsSL https://raw.githubusercontent.com/mszczodrak/sauver/main/scripts/uninstall.sh | bash">
              <span className="tok-key">curl</span> -fsSL https://raw.githubusercontent.com/mszczodrak/sauver/main/scripts/uninstall.sh | <span className="tok-key">bash</span>
            </CodeBlock>
            ...
            <div className="doc-file-list reveal" ref={addToRefs}>
              {[
                ...
                { path: '~/.claude/settings.json', desc: 'Sauver MCP entry (other settings untouched)' },
                { path: '~/.gemini/settings.json', desc: 'Sauver MCP entry (other settings untouched)' },
              ].map((f, i) => (
            ...
            <div className="doc-info-box reveal" ref={addToRefs} style={{ marginTop: '24px' }}>
              <span className="doc-info-icon">ℹ</span>
              <p>Your other AI settings and MCP servers are left completely untouched. The uninstaller only removes entries that Sauver originally added.</p>
            </div>
          </section>
